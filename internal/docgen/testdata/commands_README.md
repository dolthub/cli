...
- [dh old](/products/dolthub/cli/commands#dh-old)
...
| Command | Purpose |
| --- | --- |
| [dh old](/products/dolthub/cli/commands#dh-old) | Older group |
| [dh pr](/products/dolthub/cli/commands#dh-pr) | Review changes |
| [dh pr create](/products/dolthub/cli/commands#dh-pr-create) | Create a review |
...
| Flag | Short | Type | Default | Description |
| --- | --- | --- | --- | --- |
| <code>--help</code> | <code>-h</code> | bool | <code>false</code> | help for old |
| <code>--host</code> |  | string | <code>"example.test"</code> | Host name |
